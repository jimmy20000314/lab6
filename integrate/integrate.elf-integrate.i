# 0 "integrate.c"
# 1 "/home/jimmy/caravel-soc_fpga-lab-main/lab-wlos_baseline/testbench/integrate//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "integrate.c"
# 19 "integrate.c"
...
# 145 "integrate.c"
 ...
 (*(volatile uint32_t*)0x2600000c) = *(tmp1+4) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp1+5) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp1+6) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp1+7) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp1+8) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp1+9) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp1+10) << 16;
 ...
 (*(volatile uint32_t*)0x2600000c) = *(tmp3+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp3+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp3+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp3+4) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp3+5) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp3+6) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp3+7) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp3+8) << 16;
